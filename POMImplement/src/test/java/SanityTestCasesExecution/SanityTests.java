package SanityTestCasesExecution;
	 ...
	 @Test
	  public void TC3() throws Exception {
		  ...
		  Xls_Reader reader = new Xls_Reader("C:\\Users\\Hamd.Mehfooz\\eclipse-workspace\\preloved.xlsx");
			...
			WebElement facebook = driver.findElement(By.xpath("//*[@id='pl-register']"));
		...
		@Test
		  public void TC4() throws Exception {
			  ...
			  Xls_Reader reader = new Xls_Reader("C:\\Users\\Hamd.Mehfooz\\eclipse-workspace\\preloved.xlsx");
				...
				WebElement facebook = driver.findElement(By.xpath("//label[@for='fullName' and @class='error']"));
				String actual = facebook.getText();
				System.out.println("Actual Result is: " + actual); // print actual result
				reader.setCellData("Sheet1", "Actual", rowNum, actual);
				String act = reader.getCellData("Sheet1", "Actual", rowNum);
		...
		//screen name empty
		  ...
		  public void TC5() throws Exception {
			  ...
			  Xls_Reader reader = new Xls_Reader("C:\\Users\\Hamd.Mehfooz\\eclipse-workspace\\preloved.xlsx");
				...
				WebElement facebook = driver.findElement(By.xpath("//label[@for='screenName' and @class='error']"));
				String actual = facebook.getText();
				System.out.println("Actual Result is: " + actual); // print actual result
				reader.setCellData("Sheet1", "Actual", rowNum, actual);
				String act = reader.getCellData("Sheet1", "Actual", rowNum);
